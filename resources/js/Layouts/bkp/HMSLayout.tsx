                                                ...
                                                {item.children && isExpanded && (
                                                    ...
                                                    >
                                                        {item.children.map((child, childIndex) => {
                                                            ...
                                                            const hasChildIcon = !!ChildIcon;
                                                            const isChildStringIcon = typeof ChildIcon === 'string';
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    <Link
                                                                        href={child.href}
                                                                        className={`flex items-center gap-2 px-4 py-3 text-sm font-medium rounded-xl transition-all duration-300 ${url === child.href
