...
export default function AdmissionModal({ open, onClose, bed, onSubmit }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!form.chief_complaint.trim()) return alert("Chief complaint is required.");
    ...
    const payload = {
      ...
      primary_diagnosis: [form.icd10Description, form.chief_complaint].filter(Boolean).join(' — '),
    ...
    console.log("Form primary_diagnosis value:", form.primary_diagnosis);
    console.log("Chief complaint value at submit:", form.chief_complaint);
