...
class UpdateTestCatalogRequest extends FormRequest
{
    /**
    ...
    {
        return auth()->user()->can('update test catalogs');
    }
    ...
    {
        $testCatalog = $this->route('testCatalog');
        ...
        return [
            ...
            'code' => [
                ...
                'max:20',
                'regex:/^[A-Z0-9_-]+$/',
                Rule::unique('test_catalogs', 'code')->ignore($testCatalog),
            ],
            ...
            'price' => ['required', 'numeric', 'min:0', new \App\Rules\TestPriceRule($testCatalog?->id)],
