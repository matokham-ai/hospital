...
class AppointmentUpdated implements ShouldBroadcast
{
    ...
    public function broadcastOn(): array
    {
        return [
            ...
            new Channel('doctor-schedule.' . $this->appointment->physician_id),
        ];
    }
    ...
    public function broadcastWith(): array
    {
        ...
        $this->appointment->load(['patient.contacts']);

        try {
            // Get the date in Y-m-d format
            $dateStr = \Carbon\Carbon::parse($this->appointment->appointment_date)->format('Y-m-d');
            ...
            $status = strtoupper($this->appointment->status);
            ...
            $complaint = $this->appointment->chief_complaint ?: 'General consultation';
                ...
                'appointment' => [
                    ...
                    'extendedProps' => [
                        ...
                        'appointment' => [
                            ...
                            'physician_id' => $this->appointment->physician_id,
            ...
            \Log::error('Broadcast appointment error', [
